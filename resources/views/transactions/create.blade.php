        ...
        <main class="flex-1 p-6">
            <div class="container mx-auto p-6">
                ...
                <form action="{{ route('pos.store') }}" method="POST"
                    ...
                    <input type="text" name="name" class="border w-full p-2 rounded mb-2">

                    <label class="block">Item:</label>
                    <input type="text" name="item" class="border w-full p-2 rounded mb-2">

                    <label class="block">Amount:</label>
                    <input type="number" name="amount" class="border w-full p-2 rounded mb-2">
